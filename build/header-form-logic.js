...
async function generatePDFSelfBilling(title, formData) {
    ...
    doc.setFontSize(10);
    doc.text(
        "1. To issue self-billed invoices for all supplies made to them by the self-billee until 5 years from todayâ€™s date.",
        25,
        110,
        { maxWidth: 160 }
    );
    ...
    doc.setFontSize(10);
    doc.text(
        "1. To accept invoices raised by the self-biller on their behalf until 5 years from todayâ€™s date.",
        25,
        170,
        { maxWidth: 160 }
    );
